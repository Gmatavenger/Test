...
class TimeRangeDialog(Toplevel):
    ...
    def build_presets_frame(self, parent):
        # Mapping of preset to (earliest, latest) Splunk time modifier strings
    ...
    def select_preset(self, preset):
        # Use Splunk time modifiers directly
...
class SplunkAutomatorApp:
    ...
    def format_time_for_url(self, base_url, start_dt, end_dt):
        # If start_dt/end_dt are strings, treat as Splunk relative time, else epoch seconds
        params = {}
